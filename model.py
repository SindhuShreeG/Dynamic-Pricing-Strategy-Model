...
demand_threshold_high = 1.2  # Is the Higher demand threshold
demand_threshold_low = 0.8  # Is the Lower demand threshold
supply_threshold_high = 0.8  # Is the Higher supply threshold
supply_threshold_low = 1.2  # Is the Lower supply threshold
...
#----Comparison of Actual and Predective Price
import plotly.graph_objects as go
